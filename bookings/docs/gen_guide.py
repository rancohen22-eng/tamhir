...
<div class="wrap">
  ...
  <h2>התחברות ראשונית</h2>
  <ol class="steps">
    <li>קיבלתם <b>שם משתמש</b> ו<b>סיסמה זמנית</b> ממנהל המערכת (הסיסמה נשלחת גם במייל).</li>
    <li>פותחים את <b>קישור המערכת</b> בדפדפן (במחשב או בטלפון).</li>
    <li>מזינים שם משתמש וסיסמה ולוחצים <b>כניסה</b>.</li>
    <li>מומלץ לשמור את הסיסמה בדפדפן/מכשיר — כך בכניסות הבאות היא תמולא אוטומטית (ובמובייל אף עם זיהוי פנים/טביעת אצבע).</li>
  </ol>
  <div class="note"><b>שכחתם סיסמה?</b> פנו למנהל המערכת לאיפוס — תישלח אליכם סיסמה זמנית חדשה במייל. לאחר כניסה נשארים מחוברים.</div>
  ...
  <ol class="steps">
    ...
    <li>אפשר <b>לצרף קובץ</b> (אקסל/PDF) לבקשה — למשל טבלת נוסעים או פרטים נוספים לסוכן.</li>
  ...
  <ol class="steps">
    ...
    <li>פותחים את ההזמנה ולוחצים <b>"הגש הצעת מחיר"</b>: מזינים מחיר, פרטי נסיעה, מסמנים אם זו <b>טיסת LOW COST</b>, ומעלים <b>צילום ממערכת ההזמנות</b>.</li>
  ...
  <div class="note"><b>הצעת מחיר דחופה (יזומה):</b> בטאב <b>"הצעת מחיר דחופה"</b> אפשר לפתוח הצעה <b>ללא בקשה מוקדמת</b> — ממלאים את כל הפרטים ובוחרים <b>מחלקה</b>, וההצעה נשלחת ישירות למאשר של אותה מחלקה. הצעה דחופה מסומנת <b>באדום</b> במייל האישור ובמערכת.</div>
